...
public class Server implements Runnable {
	...
	public static final int DEFULT_PORT = 8080;
	// 默认创建8个线程用于io
	public final static int DEFULT_MAX_IO_THREAD_POOL_SIZE = 8;
	public final static String DEFULT_WEB_ROOT = "./";
	...
	public final static HashMap<String, String> contentTypeMap = new HashMap<String, String>();
	static {
		...
		contentTypeMap.put(".php", "text/html");
		...
		contentTypeMap.put(".ppt", "applications-powerpoint");
	...
	public Server(int port, String webRoot, int maxIoThreadPoolSize) {
		Server.port = port;
		Server.webRoot = webRoot;
		Server.ioPool = Executors.newFixedThreadPool(maxIoThreadPoolSize);
